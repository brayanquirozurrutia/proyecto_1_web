...
function Login() {
  return (
    <div >
      <div className="w-full sm:w-11/12 md:w-10/12 lg:w-9/12 xl:w-8/12 2xl:w-7/12 shadow-2xl rounded-2xl mx-auto p-2 my-4 bg-gradient-to-b from-slate-300 via-slate-200 to-slate-300">
